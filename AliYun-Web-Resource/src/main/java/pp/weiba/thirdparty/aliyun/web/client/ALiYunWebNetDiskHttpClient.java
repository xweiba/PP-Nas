 ...
 */
@Log4j2
public class ALiYunWebNetDiskHttpClient extends AbstractHttpClientWrap {

    public ALiYunWebNetDiskHttpClient(IHttpClient httpClient, IHttpClientAuthentication authentication) {
