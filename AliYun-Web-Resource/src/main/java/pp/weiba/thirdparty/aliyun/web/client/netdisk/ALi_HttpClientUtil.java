...
public class ALi_HttpClientUtil {
    ...
    public static void uploadFile(String url, File file, UploadFile uploadFile){
        try {
            HttpPut httpPut = new HttpPut(url);
            FileChunk chunk = uploadFile.getChunk();
            InputStreamEntity fileEntity = new InputStreamEntity(FileUtils.getZopyCopyInputStream(file, chunk.getStart(), chunk.getLength()));
            ...
            String read = IoUtil.read(httpResponse.getEntity().getContent(), Charset.defaultCharset());
            httpResponse.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
