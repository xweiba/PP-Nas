...
import pp.weiba.thirdparty.baidu.web.client.AbstractHttpClient;
import pp.weiba.thirdparty.baidu.web.client.IHttpTypeAdapter;
...
public class HutoolHttpClientAdapter extends AbstractHttpClient<HttpRequest, HttpResponse> {
    ...
    static private class HttpTypeAdapter implements IHttpTypeAdapter<HttpRequest, HttpResponse> {
        ...
        @Override
        public HttpRequest adapter(pp.weiba.thirdparty.baidu.web.client.HttpRequest request) {
        ...
        @Override
        public pp.weiba.thirdparty.baidu.web.client.HttpResponse adapter(HttpResponse response) {
            pp.weiba.thirdparty.baidu.web.client.HttpResponse responseAdapter = new pp.weiba.thirdparty.baidu.web.client.HttpResponse()
