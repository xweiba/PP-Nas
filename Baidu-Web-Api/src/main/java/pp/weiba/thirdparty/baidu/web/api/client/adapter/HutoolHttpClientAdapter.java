...
import pp.weiba.thirdparty.baidu.web.api.client.AbstractHttpClient;
import pp.weiba.thirdparty.baidu.web.api.client.IHttpTypeAdapter;
...
public class HutoolHttpClientAdapter extends AbstractHttpClient<HttpRequest, HttpResponse> {
    ...
    static private class HttpTypeAdapter implements IHttpTypeAdapter<HttpRequest, HttpResponse> {
        ...
        @Override
        public HttpRequest adapter(pp.weiba.thirdparty.baidu.web.api.client.HttpRequest request) {
        ...
        @Override
        public pp.weiba.thirdparty.baidu.web.api.client.HttpResponse adapter(HttpResponse response) {
            pp.weiba.thirdparty.baidu.web.api.client.HttpResponse responseAdapter = new pp.weiba.thirdparty.baidu.web.api.client.HttpResponse()
