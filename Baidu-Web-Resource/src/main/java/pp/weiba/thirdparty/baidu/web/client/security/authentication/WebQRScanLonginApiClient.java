...
public class WebQRScanLonginApiClient {
    ...
    public static String getQRImageHttpUrl(LoginQRParamsRequest loginQRParamsRequest) {
        return StrUtil.format(UrlConstants.GET_QR_IMAGE, loginQRParamsRequest.getGid(), loginQRParamsRequest.getCallback(), loginQRParamsRequest.getTt(), loginQRParamsRequest.getLogPage(), loginQRParamsRequest.get_());
    }

    public static QrInfoResponse getQRImageUrl(String getQRImageHttpUrlResponseBody) {
        String responseBody = getResponseBodyFormat(getQRImageHttpUrlResponseBody);
        return JSONUtils.toBean(responseBody, QrInfoResponse.class);
    }
    ...
    public static String qrLogInUrl(LonginParamsResponse params) {
    ...
    public static LonginParamsResponse buildQRLoginParams(String bduss) {
        /*
        签名参数：
        ...
        * */
        ...
        LonginParamsResponse longinParamsResponse = new LonginParamsResponse().setBduss(bduss);
        String sigAndShaOneStr = BaiduNetDiskWebMoonShadV3Script.O0OOO0(JSONUtils.toJsonStr(longinParamsResponse));
        LonginParamsResponse sigParams = JSONUtils.toBean(sigAndShaOneStr, LonginParamsResponse.class);
